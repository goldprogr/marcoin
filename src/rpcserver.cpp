...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "marcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "marcoin",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "marcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "marcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
...
#ifdef ENABLE_WALLET
    { "marcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use marcoind, or the -server option to marcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
