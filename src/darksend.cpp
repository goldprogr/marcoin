...
/* *** BEGIN DARKSEND MAGIC - marcoin **********
    Copyright (c) 2014-2015, marcoin Developers
        eduffield - evan@marcoinpay.io
        udjinm6   - udjinm6@marcoinpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat marcoin and make it unusable. To
